...
void do_start(struct char_data *ch)
{
  ...
  case CLASS_THIEF:
    SET_PLAYER_SKILL(ch, SKILL_SNEAK, 10);
    SET_PLAYER_SKILL(ch, SKILL_HIDE, 5);
    SET_PLAYER_SKILL(ch, SKILL_STEAL, 15);
    SET_PLAYER_SKILL(ch, SKILL_BACKSTAB, 10);
    SET_PLAYER_SKILL(ch, SKILL_PICK_LOCK, 10);
    SET_PLAYER_SKILL(ch, SKILL_TRACK, 10);
    break;
...
void init_spell_levels(void)
{
  ...
  spell_level(SPELL_BURNING_HANDS, CLASS_MAGIC_USER, 40);
  ...
  spell_level(SPELL_SLEEP, CLASS_MAGIC_USER, 42);
  spell_level(SPELL_LIGHTNING_BOLT, CLASS_MAGIC_USER, 50);
  ...
  spell_level(SPELL_FIREBALL, CLASS_MAGIC_USER, 45);
  ...
  spell_level(SPELL_EARTHQUAKE, CLASS_CLERIC, 45);
  spell_level(SPELL_DISPEL_EVIL, CLASS_CLERIC, 48);
  spell_level(SPELL_DISPEL_GOOD, CLASS_CLERIC, 48);
  spell_level(SPELL_SANCTUARY, CLASS_CLERIC, 15);
  spell_level(SPELL_CALL_LIGHTNING, CLASS_CLERIC, 50);
